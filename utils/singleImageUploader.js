...
export const parser = multer({ storage: storage });// This will parse the incoming request and store the image in req.file or req.files depending on the type of upload you are doing, single or multiple.
...
// 'image' is the name of the field in the form data that contains the image file. Remember that the form is not in JSON format, it is in multipart/form-data format, and this format holds the form name as set in the html form and thats what we use to get the image file from the form data.
