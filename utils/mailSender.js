...
export const sendVerificationMail = async (userName, userEmail, token) => {
    ...
    try {
        // create a transporter object using the nodemailer module that will be used to send the email. transporter is able to connect to the outgoing smtp server and use it send the email.
         ...
         const mailOptions = {
             ...
             to: userEmail,
             subject: 'Gigish welcome message',
             text: `Hello ${userName}, kindly click on the following link to verify your email address: ${process.env.ENDPOINT_HOST_URL}/verifyEmail/?token=${token}`,
             html:  `<html>
<head>
  <style>
    body {
...
<body>
  <div class="email-container">
    ...
    <p>Gigish Team</p>
    <div class="footer">
      <p>&copy; ${new Date().getFullYear()} Gigish Inc. All rights reserved.</p>
    </div>
  </div>
</body>
</html>`
